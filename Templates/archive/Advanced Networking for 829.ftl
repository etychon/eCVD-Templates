...
<#-- WGB routes, track statement, and SLA -->
<#if wgbSSID?has_content *Something like this>
ip route 9.9.9.9 255.255.255.255 Vlan50 dhcp
ip route 9.9.9.9 255.255.255.255 Null0 3
ip route 0.0.0.0 0.0.0.0 Vlan50 dhcp 50

ip sla 50
 icmp-echo 9.9.9.9 source-interface Vlan50
 frequency 25
