      ...
      <#if wan_link4_interface == "cellular1" || wan_link4_interface == "cellular2">
        ...
        <#assign placeholder = far.wan4SecondSIMPinDLTE!"">
          <#if wan_link4_interface == "cellular1">
            ...
            <#assign cell1_sim1_time = far.wan4TimeDLTE!"660">
          <#elseif wan_link4_interface == "cellular2">
            ...
            <#assign cell2_sim1_time = far.wan4TimeDLTE!"660">
          </#if>
        </#if>
      </#if>
    </#if>
...
<#if modifyTunnelList?has_content>
  event manager applet modify_tunnel_priorities
   ...
   !action 045  syslog msg "register_present==>$register_present"
    ...
    action 147  cli command "no event manager applet cell_pnp_Cellular0/5/0"
...
<#-- Generate RSA keys for SSH -->
    ...
    <#assign wan_uplinks = { "Uplink1" : {
                            ...
                            "Uplink4" : {
                                          "type" : wan_link4_interface!"",
                                          "second_sim" : far.wan4SecondSimEnabledDLTE!"false",
                                          "sim0_apn" : far.wan4APNDLTE!"",
                                          "sim0_pin" : far.wan4SIMPinDLTE!"",
                                          "sim0_username" : far.wan4APNUsernameDLTE!"",
                                          "sim0_password" : far.wan4APNPasswordDLTE!"",
                                          "sim1_apn" : far.wan4SecondAPNDLTE!"",
                                          "sim1_pin" : far.wan4SecondSIMPinDLTE!"",
                                          "sim1_username" : far.wan4SecondAPNUsernameDLTE!"",
                                          "sim1_password" : far.wan4SecondAPNPasswordDLTE!""
                                        }
                                        }>
  ...
  <#if far.wifiDeploymentMode?has_content>
    ...
    <#elseif wifidepmode == "controller">
      <#if far.primaryControllerIP?has_content>
        ...
        <#if far.wifi6Mode?has_content>
          <#assign apMode = far.wifi6Mode>
          <#if apMode != "CAPWAP">
            <#stop 'Please check if Wi-Fi6 module is plugged in and set to CAPWAP mode.'>
          </#if>
        </#if>
      </#if>
